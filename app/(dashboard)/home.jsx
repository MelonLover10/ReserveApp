...
function computeTotalExchanged(docs) {
  let total = 0;
  docs.forEach((doc) => {
    const data = doc.data ? doc.data() : doc;
    if (data.completionType === "nocoordination") return;

    if (data.exchangedQuantities && Object.keys(data.exchangedQuantities).length > 0) {
      Object.values(data.exchangedQuantities).forEach((qty) => {
        total += qty || 0;
      });
    } else {
...
const Home = () => {
  const [totalItemsDistributed, setTotalItemsDistributed] = useState(0);
  ...
  useEffect(() => {
    ...
    const unsubscribe = onSnapshot(
      completedQuery,
      (snapshot) => {
        setTotalItemsDistributed(computeTotalExchanged(snapshot.docs));
        setLoading(false);
      },
      (error) => {
    ...
    <ThemedView style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <ThemedText title style={styles.heading}>Reserve</ThemedText>
          <Spacer height={20} />
          <ThemedText style={styles.subheading}>Our Mission</ThemedText>
          ...
          <View style={styles.squareRow}>
            ...
            <View style={styles.square}>
              <ThemedText style={styles.statText}>
                {loading ? '...' : formatNumber(totalItemsDistributed)}
              </ThemedText>
          ...
          <View style={styles.mascotSection}>
            ...
            <View style={styles.speechWrapper}>
              <View style={styles.speechBubble}>
                <ThemedText style={styles.mascotTitle}>Make an Impact</ThemedText>
          ...
          <View style={styles.globalStatsCard}>
            ...
            <View style={styles.globalStatItem}>
              ...
              <View style={styles.globalTextWrap}>
                <ThemedText style={styles.globalStatTitle}>244 Million Children</ThemedText>
            ...
            <View style={styles.globalStatItem}>
              ...
              <View style={styles.globalTextWrap}>
                <ThemedText style={styles.globalStatTitle}>Learning Poverty</ThemedText>
                <ThemedText style={styles.globalStatDesc}>
            ...
            <View style={styles.globalStatItem}>
              ...
              <View style={styles.globalTextWrap}>
                <ThemedText style={styles.globalStatTitle}>Classroom Gaps</ThemedText>
                <ThemedText style={styles.globalStatDesc}>
            ...
            <View style={styles.globalStatItem}>
              ...
              <View style={styles.globalTextWrap}>
                <ThemedText style={styles.globalStatTitle}>Teacher Shortage</ThemedText>
                <ThemedText style={styles.globalStatDesc}>
          ...
          <View style={styles.howItWorksCard}>
            <ThemedText style={styles.subheading}>How Reserve Works</ThemedText>
            <Spacer height={10} />
        ...
        <Spacer height={25} />
        <ThemedText style={styles.subheading}>Personal Statements</ThemedText>
        <View style={styles.storyCard}>
          <ThemedText style={styles.storyText}>
            "Reserve is one step forward in increasing access to school supplies."
          </ThemedText>
          <ThemedText style={styles.storyAuthor}>— Local Teacher</ThemedText>
        </View>
        <View style={styles.storyCard}>
          <ThemedText style={styles.storyText}>
